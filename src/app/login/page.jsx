          ...
          <div className="relative hidden lg:flex bg-[#060b1d] overflow-hidden flex-col justify-between p-8 xl:p-12 min-h-full">
            ...
            <div className="relative z-10 mt-20">
              <h2 className="text-5xl font-black leading-tight text-white">
                Welcome Back
                <br />
                to <span className="text-violet-500">IdeaVault</span>
              </h2>

              <p className="mt-6 text-lg leading-8 text-slate-300 max-w-md">
                Sign in to continue sharing, discovering and building powerful
                ideas.
              </p>
            </div>
            {/* Illustration */}
